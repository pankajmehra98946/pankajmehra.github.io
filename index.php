...
<nav class="navbar navbar-expand-sm  navbar-dark" style="background-color: #3333ff;font: 15px Roboto, sans-serif;"  >
  ...
  <li class="nav-item">
    ...
    <li class="nav-item">
      <a class="nav-link" href="deshboard.php" style="color: white"><i class='fas fa-home ' style='font-size:14px;color: white'></i>&nbsp;My Deshboard</a>
    </li>
    <li class="nav-item">
      <a class="nav-link" href="login.php" style="color: white"><i class="fas fa-users-cog" style='font-size:14px;color: white'></i>&nbsp;Employer</a>
    </li>
</ul>
</nav>
...
<a class="navbar-brand" href="index11.php">
  ...
  <div class="collapse navbar-collapse " id="collapsibleNavbar">
    <ul class="navbar-nav " >
      ...
      <li class="nav-item">
        <a class="nav-link" href="login.php" style="color: black">My Deshboard</a>
      </li>
      <li class="nav-item">
...
<div class="container-fluid px-0 " style="  background-image: url('desk8.jpg');  background-repeat: no-repeat;  background-position: center; background-size: 100%;font: 15px Roboto, sans-serif;box-sizing: boder-box ">
  <div class="row mx-0 my-0 " style="background: linear-gradient(to right, rgba(22, 80, 226, 0.95) 0%, rgba(126, 81, 236, 0.95) 100%);  opacity: 0.9;"> 
     <div class="  mx-auto  text-center text-white py-4"  >
     	<h1 class="" >Find The Best Job For Your Future</h1>
     	<p>It is a long established fact that a reader will be distracted by the readable.</p>

      <form class="form-inline py-1" action="login.php">
...
<div class="row p-2 mx-4" >
  ...
  <div class="col-lg-6 col-md-6 col-sm-12 mt-3 d-inline-block" >
    <div class="col-lg-12 col-md-12 col-sm-12  d-inline-block bg-white" style="height: 250px;border-radius:5px">
    <div class="container" >
      <div class="row pt-2" style="height: 80px">
      <div class="col-4 "><img src="imageupload/<?php echo $fetch['image']; ?>"  style="height: 70px; width: 70px; "> </div>
       <div class="col-4"><h5 class="font-weight-semibold mt-1"><?php echo $fetch['comname']; ?></h5> </div>
        <div class="col-4 ml-auto mt-4">
           <a class="btn btn-light mt-6 mr-4 font-weight-semibold text-dark" href="login.php"><i class="fa fa-briefcase"></i>    
      ...
      <div class="col-12">
        <table class="table row table-borderless w-100 m-0 text-nowrap "> 
          <tbody class="col-lg-12 col-xl-12 p-0">
            ...
            <td class="p-1"><span>:</span></td>
            <td class="p-1"><span><?php echo substr($fetch['address'],"0","20") ; ?>...</span></td></tr> 
          </tbody>
        </table>

      </div>
        
        <div class="mt-3"> <a class="btn btn-light" href="login.php" >Apply Now</a> </div>
...
<div class="col-lg-12 text-center" > <button class="btn btn-success col-lg-2 " > <a href="login.php " class="text-dark" style="text-decoration: none">more</a> </button> </div>
</div>
